...
function TodoReadPage(props) {
    ...
    const getComponent = () => {
        if(cmd === 'read'){
            return <TodoReadComponent id={id} setResult={setResult} moveToList={moveToList} moveToModify={moveToModify}/>
        } else if(cmd === 'modify'){
            return <TodoModifyComponent id={id} setResult={setResult} moveToList={moveToList} moveToBack={moveToBack}/>
        }

...
select ename, sal, deptno from emp where sal between 2000 and 3000 order by ename;
​
...
select ename, sal, comm from emp where comm is null order by sal desc, comm desc;

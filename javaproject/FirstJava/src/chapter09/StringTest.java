...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("str1 == str3 =>    " + (str1 == str3));	// 참조값 비교 false
		
		System.out.println(str1.equals(str3));	// 문자열 하나하나 비교 true
		...
		System.out.println();
		System.out.println(str.startsWith("He"));	// http:// https://
		System.out.println(str.endsWith(".pdf"));	// 확장자 찾기: *.jpg
